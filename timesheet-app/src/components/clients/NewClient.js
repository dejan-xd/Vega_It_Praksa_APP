...
function NewClient({ showModal, closeModal }) {
    ...
    const createClientHandle = data => {
        createClient({ ...data, zipCode: parseInt(data.zipCode) })
            .then(res => {
        ...
        <div>
            ...
            <div id="fancybox-wrap" className="fancybox-wrap" style={showStyle}>
                <div id="fancybox-outer">
                            ...
                            <div id="new-member" className="new-member-inner">
                                ...
                                <form className="new-member-inner">
                                    <ul className="form">
                                        ...
                                        <li>
                                            <label>Country:</label>
                                            <select defaultValue={'DEFAULT'} {...register("country", { required: true })} >
                    ...
                    <a id="fancybox-close" style={{ display: "inline" }} onClick={closeModal}> </a>
                </div>
            </div>
        </div>
    )
